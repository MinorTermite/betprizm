...
4. GitHub уведомляет Netlify о push

5. Netlify автоматически пересобирает сайт
   ├─ Деплой новой версии
...
Вариант 2: Через Netlify Function
...
### 3. update-matches.js (Netlify Function)
```javascript
Задачи:
...
- **Node.js 18** - Netlify Functions
- **GitHub Actions** - CI/CD

### Инфраструктура
- **GitHub** - хостинг кода, автоматизация
- **Netlify** - хостинг сайта, CDN, serverless
...
✅ Rate limiting (Netlify встроенный)
✅ DDoS защита (Netlify CDN)
...
- Netlify Function: <1 секунда на запрос
